...
% Enable hyperlinks and URL handling (load near the end of preamble)
...
\bibitem{McDougall} 
``Voting Matters.'' 
McDougall Trust, \url{https://www.mcdougall.org.uk/}.

\bibitem{VotingTheory} 
``Probabilistic voting model.'' 
In \textit{Voting Theory}, \url{https://en.wikipedia.org/wiki/Probabilistic_voting}.

\bibitem{GoogleTrends} 
``Google Trends.'' 
Google LLC, \url{https://trends.google.com/}.

\bibitem{pytrends} 
General Mills. 
``pytrends: Unofficial API for Google Trends.'' 
GitHub repository, \url{https://github.com/GeneralMills/pytrends}.
